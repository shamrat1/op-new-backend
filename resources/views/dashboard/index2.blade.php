                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td><a href="{{ action('PageController@invoice') }}">OR9842</a></td>
                                    ...
                                    <tr>
                                        <td><a href="{{ action('PageController@invoice') }}">OR1848</a></td>
                                    ...
                                    <tr>
                                        <td><a href="{{ action('PageController@invoice') }}">OR7429</a></td>
                                        <td>iPhone 6 Plus</td>
