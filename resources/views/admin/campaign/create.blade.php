                ...
                <form action="{{ route('campaign.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('effective_on') is-invalid @enderror" value="{{ old('effective_on') }}" name="effective_on" id="effective_on">
                            @error('effective_on') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="col-sm-12 col-md-4 form-group">
                            <label for="min_amount">Min Amount</label>
                            <input type="text" class="form-control @error('min_amount') is-invalid @enderror" value="{{ old('min_amount') }}" name="min_amount" id="min_amount">
                            @error('min_amount') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="col-sm-12 col-md-4 form-group">
                            <label for="max_amount">Max Amount</label>
                            <input type="text" class="form-control @error('max_amount') is-invalid @enderror" value="{{ old('max_amount') }}" name="max_amount" id="max_amount">
                        ...
                        <div class="col-sm-12 col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('max_amount') is-invalid @enderror" value="{{ old('reward_amount') }}" name="reward_amount" id="reward_amount">
                        ...
                        <div class="col-sm-12 col-md-6 form-group">
                            ...
                            <input type="text" class="form-control @error('start_date') is-invalid @enderror" value="{{ old('start_date') }}" name="start_date" id="start_date">
                            @error('start_date') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="col-sm-12 col-md-6 form-group">
                            <label for="end_date">End Date</label>
                            <input type="datetime" class="form-control @error('end_date') is-invalid @enderror" value="{{ old('end_date') }}" name="end_date" id="end_date">
